...
class TypeGuards {
    ...
    static isAnyKeyword(node) {
        return node.getKind() === ts.SyntaxKind.AnyKeyword;
    }
    ...
    static isArrayBindingPattern(node) {
        return node.getKind() === ts.SyntaxKind.ArrayBindingPattern;
    }
    static isArrayLiteralExpression(node) {
        return node.getKind() === ts.SyntaxKind.ArrayLiteralExpression;
    }
    static isArrayTypeNode(node) {
        return node.getKind() === ts.SyntaxKind.ArrayType;
    }
    static isArrowFunction(node) {
        return node.getKind() === ts.SyntaxKind.ArrowFunction;
    }
    static isAsExpression(node) {
        return node.getKind() === ts.SyntaxKind.AsExpression;
    }
    ...
    static isAwaitExpression(node) {
        return node.getKind() === ts.SyntaxKind.AwaitExpression;
    }
    static isAwaitableNode(node) {
        return node.getKind() === ts.SyntaxKind.ForOfStatement;
    }
    static isBinaryExpression(node) {
        return node.getKind() === ts.SyntaxKind.BinaryExpression;
    }
    static isBindingElement(node) {
        return node.getKind() === ts.SyntaxKind.BindingElement;
    }
    ...
    static isBlock(node) {
        return node.getKind() === ts.SyntaxKind.Block;
    }
    ...
    static isBooleanKeyword(node) {
        return node.getKind() === ts.SyntaxKind.BooleanKeyword;
    }
    ...
    static isBreakStatement(node) {
        return node.getKind() === ts.SyntaxKind.BreakStatement;
    }
    static isCallExpression(node) {
        return node.getKind() === ts.SyntaxKind.CallExpression;
    }
    static isCallSignatureDeclaration(node) {
        return node.getKind() === ts.SyntaxKind.CallSignature;
    }
    static isCaseBlock(node) {
        return node.getKind() === ts.SyntaxKind.CaseBlock;
    }
    static isCaseClause(node) {
        return node.getKind() === ts.SyntaxKind.CaseClause;
    }
    static isCatchClause(node) {
        return node.getKind() === ts.SyntaxKind.CatchClause;
    }
    ...
    static isClassExpression(node) {
        return node.getKind() === ts.SyntaxKind.ClassExpression;
    }
    ...
    static isCommaListExpression(node) {
        return node.getKind() === ts.SyntaxKind.CommaListExpression;
    }
    static isComputedPropertyName(node) {
        return node.getKind() === ts.SyntaxKind.ComputedPropertyName;
    }
    static isConditionalExpression(node) {
        return node.getKind() === ts.SyntaxKind.ConditionalExpression;
    }
    ...
    static isContinueStatement(node) {
        return node.getKind() === ts.SyntaxKind.ContinueStatement;
    }
    static isDebuggerStatement(node) {
        return node.getKind() === ts.SyntaxKind.DebuggerStatement;
    }
    ...
    static isDecorator(node) {
        return node.getKind() === ts.SyntaxKind.Decorator;
    }
    static isDefaultClause(node) {
        return node.getKind() === ts.SyntaxKind.DefaultClause;
    }
    static isDeleteExpression(node) {
        return node.getKind() === ts.SyntaxKind.DeleteExpression;
    }
    static isDoStatement(node) {
        return node.getKind() === ts.SyntaxKind.DoStatement;
    }
    static isElementAccessExpression(node) {
        return node.getKind() === ts.SyntaxKind.ElementAccessExpression;
    }
    static isEmptyStatement(node) {
        return node.getKind() === ts.SyntaxKind.EmptyStatement;
    }
    static isEnumDeclaration(node) {
        return node.getKind() === ts.SyntaxKind.EnumDeclaration;
    }
    static isEnumMember(node) {
        return node.getKind() === ts.SyntaxKind.EnumMember;
    }
    ...
    static isExportAssignment(node) {
        return node.getKind() === ts.SyntaxKind.ExportAssignment;
    }
    ...
    static isExportSpecifier(node) {
        return node.getKind() === ts.SyntaxKind.ExportSpecifier;
    }
    ...
    static isExpressionStatement(node) {
        return node.getKind() === ts.SyntaxKind.ExpressionStatement;
    }
    static isExpressionWithTypeArguments(node) {
        return node.getKind() === ts.SyntaxKind.ExpressionWithTypeArguments;
    }
    ...
    static isExternalModuleReference(node) {
        return node.getKind() === ts.SyntaxKind.ExternalModuleReference;
    }
    static isFalseKeyword(node) {
        return node.getKind() === ts.SyntaxKind.FalseKeyword;
    }
    static isForInStatement(node) {
        return node.getKind() === ts.SyntaxKind.ForInStatement;
    }
    static isForOfStatement(node) {
        return node.getKind() === ts.SyntaxKind.ForOfStatement;
    }
    static isForStatement(node) {
        return node.getKind() === ts.SyntaxKind.ForStatement;
    }
    static isFunctionDeclaration(node) {
        return node.getKind() === ts.SyntaxKind.FunctionDeclaration;
    }
    static isFunctionExpression(node) {
        return node.getKind() === ts.SyntaxKind.FunctionExpression;
    }
    ...
    static isHeritageClause(node) {
        return node.getKind() === ts.SyntaxKind.HeritageClause;
    }
    ...
    static isIfStatement(node) {
        return node.getKind() === ts.SyntaxKind.IfStatement;
    }
    ...
    static isInferKeyword(node) {
        return node.getKind() === ts.SyntaxKind.InferKeyword;
    }
    ...
    static isJSDocAugmentsTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocAugmentsTag;
    }
    static isJSDocClassTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocClassTag;
    }
    static isJSDocFunctionType(node) {
        return node.getKind() === ts.SyntaxKind.JSDocFunctionType;
    }
    static isJSDocParameterTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocParameterTag;
    }
    ...
    static isJSDocPropertyTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocPropertyTag;
    }
    static isJSDocReturnTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocReturnTag;
    }
    static isJSDocSignature(node) {
        return node.getKind() === ts.SyntaxKind.JSDocSignature;
    }
    ...
    static isJSDocTypeExpression(node) {
        return node.getKind() === ts.SyntaxKind.JSDocTypeExpression;
    }
    static isJSDocTypeTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocTypeTag;
    }
    static isJSDocTypedefTag(node) {
        return node.getKind() === ts.SyntaxKind.JSDocTypedefTag;
    }
    ...
    static isJsxAttribute(node) {
        return node.getKind() === ts.SyntaxKind.JsxAttribute;
    }
    ...
    static isJsxClosingElement(node) {
        return node.getKind() === ts.SyntaxKind.JsxClosingElement;
    }
    static isJsxClosingFragment(node) {
        return node.getKind() === ts.SyntaxKind.JsxClosingFragment;
    }
    static isJsxElement(node) {
        return node.getKind() === ts.SyntaxKind.JsxElement;
    }
    static isJsxExpression(node) {
        return node.getKind() === ts.SyntaxKind.JsxExpression;
    }
    static isJsxFragment(node) {
        return node.getKind() === ts.SyntaxKind.JsxFragment;
    }
    static isJsxOpeningElement(node) {
        return node.getKind() === ts.SyntaxKind.JsxOpeningElement;
    }
    static isJsxOpeningFragment(node) {
        return node.getKind() === ts.SyntaxKind.JsxOpeningFragment;
    }
    static isJsxSelfClosingElement(node) {
        return node.getKind() === ts.SyntaxKind.JsxSelfClosingElement;
    }
    static isJsxSpreadAttribute(node) {
        return node.getKind() === ts.SyntaxKind.JsxSpreadAttribute;
    }
    ...
    static isJsxText(node) {
        return node.getKind() === ts.SyntaxKind.JsxText;
    }
    static isLabeledStatement(node) {
        return node.getKind() === ts.SyntaxKind.LabeledStatement;
    }
    ...
    static isMetaProperty(node) {
        return node.getKind() === ts.SyntaxKind.MetaProperty;
    }
    static isMethodDeclaration(node) {
        return node.getKind() === ts.SyntaxKind.MethodDeclaration;
    }
    static isMethodSignature(node) {
        return node.getKind() === ts.SyntaxKind.MethodSignature;
    }
    ...
    static isModuleBlock(node) {
        return node.getKind() === ts.SyntaxKind.ModuleBlock;
    }
    ...
    static isNamedExports(node) {
        return node.getKind() === ts.SyntaxKind.NamedExports;
    }
    ...
    static isNewExpression(node) {
        return node.getKind() === ts.SyntaxKind.NewExpression;
    }
    static isNoSubstitutionTemplateLiteral(node) {
        return node.getKind() === ts.SyntaxKind.NoSubstitutionTemplateLiteral;
    }
    static isNonNullExpression(node) {
        return node.getKind() === ts.SyntaxKind.NonNullExpression;
    }
    static isNotEmittedStatement(node) {
        return node.getKind() === ts.SyntaxKind.NotEmittedStatement;
    }
    static isNullLiteral(node) {
        return node.getKind() === ts.SyntaxKind.NullKeyword;
    }
    static isNumberKeyword(node) {
        return node.getKind() === ts.SyntaxKind.NumberKeyword;
    }
    static isNumericLiteral(node) {
        return node.getKind() === ts.SyntaxKind.NumericLiteral;
    }
    static isObjectBindingPattern(node) {
        return node.getKind() === ts.SyntaxKind.ObjectBindingPattern;
    }
    static isObjectKeyword(node) {
        return node.getKind() === ts.SyntaxKind.ObjectKeyword;
    }
    static isObjectLiteralExpression(node) {
        return node.getKind() === ts.SyntaxKind.ObjectLiteralExpression;
    }
    static isOmittedExpression(node) {
        return node.getKind() === ts.SyntaxKind.OmittedExpression;
    }
    ...
    static isParenthesizedExpression(node) {
        return node.getKind() === ts.SyntaxKind.ParenthesizedExpression;
    }
    ...
    static isPartiallyEmittedExpression(node) {
        return node.getKind() === ts.SyntaxKind.PartiallyEmittedExpression;
    }
    static isPostfixUnaryExpression(node) {
        return node.getKind() === ts.SyntaxKind.PostfixUnaryExpression;
    }
    static isPrefixUnaryExpression(node) {
        return node.getKind() === ts.SyntaxKind.PrefixUnaryExpression;
    }
    ...
    static isPropertyAccessExpression(node) {
        return node.getKind() === ts.SyntaxKind.PropertyAccessExpression;
    }
    static isPropertyAssignment(node) {
        return node.getKind() === ts.SyntaxKind.PropertyAssignment;
    }
    static isPropertyDeclaration(node) {
        return node.getKind() === ts.SyntaxKind.PropertyDeclaration;
    }
    ...
    static isPropertySignature(node) {
        return node.getKind() === ts.SyntaxKind.PropertySignature;
    }
    static isQualifiedName(node) {
        return node.getKind() === ts.SyntaxKind.QualifiedName;
    }
    ...
    static isRegularExpressionLiteral(node) {
        return node.getKind() === ts.SyntaxKind.RegularExpressionLiteral;
    }
    ...
    static isReturnStatement(node) {
        return node.getKind() === ts.SyntaxKind.ReturnStatement;
    }
    ...
    static isSemicolonToken(node) {
        return node.getKind() === ts.SyntaxKind.SemicolonToken;
    }
    ...
    static isShorthandPropertyAssignment(node) {
        return node.getKind() === ts.SyntaxKind.ShorthandPropertyAssignment;
    }
    ...
    static isSourceFile(node) {
        return node.getKind() === ts.SyntaxKind.SourceFile;
    }
    static isSpreadAssignment(node) {
        return node.getKind() === ts.SyntaxKind.SpreadAssignment;
    }
    static isSpreadElement(node) {
        return node.getKind() === ts.SyntaxKind.SpreadElement;
    }
    ...
    static isStringKeyword(node) {
        return node.getKind() === ts.SyntaxKind.StringKeyword;
    }
    ...
    static isSwitchStatement(node) {
        return node.getKind() === ts.SyntaxKind.SwitchStatement;
    }
    static isSymbolKeyword(node) {
        return node.getKind() === ts.SyntaxKind.SymbolKeyword;
    }
    static isSyntaxList(node) {
        return node.getKind() === ts.SyntaxKind.SyntaxList;
    }
    static isTaggedTemplateExpression(node) {
        return node.getKind() === ts.SyntaxKind.TaggedTemplateExpression;
    }
    static isTemplateExpression(node) {
        return node.getKind() === ts.SyntaxKind.TemplateExpression;
    }
    static isTemplateHead(node) {
        return node.getKind() === ts.SyntaxKind.TemplateHead;
    }
    static isTemplateMiddle(node) {
        return node.getKind() === ts.SyntaxKind.TemplateMiddle;
    }
    static isTemplateSpan(node) {
        return node.getKind() === ts.SyntaxKind.TemplateSpan;
    }
    static isTemplateTail(node) {
        return node.getKind() === ts.SyntaxKind.TemplateTail;
    }
    ...
    static isThrowStatement(node) {
        return node.getKind() === ts.SyntaxKind.ThrowStatement;
    }
    static isTrueKeyword(node) {
        return node.getKind() === ts.SyntaxKind.TrueKeyword;
    }
    static isTryStatement(node) {
        return node.getKind() === ts.SyntaxKind.TryStatement;
    }
    ...
    static isTypeOfExpression(node) {
        return node.getKind() === ts.SyntaxKind.TypeOfExpression;
    }
    ...
    static isUndefinedKeyword(node) {
        return node.getKind() === ts.SyntaxKind.UndefinedKeyword;
    }
    ...
    static isVariableDeclarationList(node) {
        return node.getKind() === ts.SyntaxKind.VariableDeclarationList;
    }
    static isVariableStatement(node) {
        return node.getKind() === ts.SyntaxKind.VariableStatement;
    }
    static isVoidExpression(node) {
        return node.getKind() === ts.SyntaxKind.VoidExpression;
    }
    static isWhileStatement(node) {
        return node.getKind() === ts.SyntaxKind.WhileStatement;
    }
    static isWithStatement(node) {
        return node.getKind() === ts.SyntaxKind.WithStatement;
    }
    static isYieldExpression(node) {
        return node.getKind() === ts.SyntaxKind.YieldExpression;
    }
    ...
    getNewText(inputText) {
        ...
        function getRemovalPos() {
            ...
            if (parent.getPos() === firstPos)
                return children[0].getNonWhitespaceStart();
...
class Node {
    ...
    *_getAncestorsIterator(includeSyntaxLists) {
    ...
    getParentIfKindOrThrow(kind) {
        return throwIfNullOrUndefined(this.getParentIfKind(kind), `Expected a parent with a syntax kind of ${getSyntaxKindName(kind)}.`);
    }
...
function insertOverloads(opts) {
    ...
    const children = getRangeWithoutCommentsFromArray(parentSyntaxList.getChildren(), mainIndex, structures.length, opts.expectedSyntaxKind);
...
class GetAccessorDeclaration extends GetAccessorDeclarationBase {
    ...
    getSetAccessor() {
        const parent = this.getParentIfKindOrThrow(ts.SyntaxKind.ClassDeclaration);
        const thisName = this.getName();
...
class SetAccessorDeclaration extends SetAccessorDeclarationBase {
    ...
    getGetAccessor() {
        ...
        return parent.getInstanceProperties()
            .find(p => p.getKind() === ts.SyntaxKind.GetAccessor && p.getName() === thisName);
    }
...
class Type {
    ...
    getDefaultOrThrow() {
        return throwIfNullOrUndefined(this.getDefault(), "Expected to find a constraint.");
    }
    getDefault() {
...
const kindToWrapperMappings = {
    ...
    [ts.SyntaxKind.TypePredicate]: TypeNode,
