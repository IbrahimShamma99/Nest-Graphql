...
export declare class ResolversExplorerService extends BaseExplorerService {
    ...
    createSubscriptionMetadata(createSubscribeContext: Function, subscriptionOptions: SubscriptionOptions, resolverMetadata: ResolverMetadata, instanceRef: Object): {
        callback: {
            subscribe: any;
            resolve: any;
        };
